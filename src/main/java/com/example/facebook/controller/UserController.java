...
public class UserController extends AbstractController {
    ...
    public ResponseEntity<List<FriendDTO>> findFriendsByName(HttpSession session, @PathVariable String name) {
        long userId = getUserById(session);
    ...
    public ResponseEntity<FriendDTO> addFriend(HttpSession session, @PathVariable (name = "fid") long friendId) {
        long userId = getUserById(session);
    ...
    public ResponseEntity<FriendDTO> followFriend(HttpSession session, @PathVariable (name = "fid") long friendId) {
        long userId = getUserById(session);
        return new ResponseEntity<>(userService.followFriend(userId, friendId), HttpStatus.OK);
    }

    @PostMapping("users/unfollow/{fid}")
    public void unfollowFriend(HttpSession session, @PathVariable (name = "fid") long friendId) {
        long userId = getUserById(session);
